...
%      headerfont=\Large, %Sans Serif
 ...
 \\
نسخه ۲.۴، ۲۰ بهمن ۱۳۹۴، ۲ فوریه ۲۰۱۶
 }}
 % University logo
 {
\begin{tabular}{r}
...
\begin{itemize}
    ...
    \item \lr{\texttt{paperwidth=length, paperheight=length}}: تنظیم عرض/ارتفاع صفحه. 
...
\footnotetext{
نسخه ۲.۲ بر خلاف نسخه اولیّه هر دو نوع پوستر پارسی و لاتین را پشتیبانی می‌کند. }
\end{posterbox} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{poster}
\end{document}
